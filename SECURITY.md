...
- **Primary channel:** [Open a private security advisory](https://github.com/enchanted-plugins/weaver/security/advisories/new) on this repository.
...
- Bypass of the shared [hooks contract](shared/conduct/hooks.md) — any hook that decides instead of advises.
